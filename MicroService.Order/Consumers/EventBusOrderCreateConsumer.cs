...
namespace MicroService.Order.Consumers
{
    public class EventBusOrderCreateConsumer
    {
        ...
        private async void ReceivedEvent(object sender, BasicDeliverEventArgs e)
        {
            ...
            if (e.RoutingKey == EventBusConstants.OrderCreateQueue)
            {
                ...
                command.SellerUserName = @event.SellerUserName;
        ...
        {
            _persistentConnection.Dispose();//Kanalı acık bırakmıyoruz kontrollü bir şekilde dispose ediyoruz.
        }
    }
}
